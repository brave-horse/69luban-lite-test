...
#include "rtconfig.h"
#include "stddef.h"
#include "Screen_rotate.h"

#define SCREEN_MAX_WIDTH  720
#define SCREEN_MAX_HEIGHT 1440

#define IMAGE_MAX_WIDTH   335
#define IMAGE_MAX_HEIGHT  335
...
static unsigned int startup_logo_rotation_flags;

static void startup_logo_rotation_init(void)
{
    startup_logo_rotation_flags = screen_rotation_get()
                                      ? MPP_ROTATION_0
                                      : MPP_ROTATION_180;
}

static unsigned int startup_logo_rotation(void)
{
    return startup_logo_rotation_flags;
}
                         ...
                         u32 layer_id, bool is_first_img)
{
    ...
    blt.ctrl.flags = startup_logo_rotation();
