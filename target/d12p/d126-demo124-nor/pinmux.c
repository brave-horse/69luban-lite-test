...
struct aic_pinmux aic_pinmux_config[] = {
    ...
    {8, PIN_PULL_UP, 7, "PE.12"},
    {8, PIN_PULL_UP, 7, "PE.13"},
    {8, PIN_PULL_UP, 7, "PE.14"},
    {8, PIN_PULL_UP, 7, "PE.15"},
    {8, PIN_PULL_UP, 7, "PE.16"},
    {8, PIN_PULL_UP, 7, "PE.17"},
#endif
    ...
    {1, PIN_PULL_UP, 3, AIC_WIRELESS_WIFI_WK_HOST_GPIO},
    {1, PIN_PULL_UP, 3, AIC_WIRELESS_BT_PWR_GPIO, FLAG_POWER_PIN},
    {1, PIN_PULL_UP, 3, AIC_WIRELESS_PWR_GPIO, FLAG_POWER_PIN},  // WIFI_PWR_ON
#endif
#ifdef AIC_USING_DVP
