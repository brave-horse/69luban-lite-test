...
{
    uint32_t stuck_cnt = i2c_dev->stuck_time;
    stuck_cnt *= i2c_dev->module_clk / i2c_dev->target_rate;

    writel(stuck_cnt, i2c_dev->reg_base + I2C_SCL_STUCK_TIMEOUT);
    writel(stuck_cnt, i2c_dev->reg_base + I2C_SDA_STUCK_TIMEOUT);
}
