...
/* JPEG decode plus NV12-to-RGB conversion has a deeper call chain than a
 * normal GE2D draw task. Keep this separate from the generic LVGL stack. */
#define LV_GE2D_RENDER_THREAD_STACK_SIZE (16 * 1024)
...
#if LV_USE_OS
    lv_thread_init(&draw_ge2d_unit->thread, LV_THREAD_PRIO_HIGH, ge2d_render_thread_cb,
                   LV_GE2D_RENDER_THREAD_STACK_SIZE, draw_ge2d_unit);
#endif
}
