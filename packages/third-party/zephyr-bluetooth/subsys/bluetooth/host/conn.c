...
static struct k_sem pending_recycled_events = { 0 };
...
int bt_conn_init(void)
{
	...
	k_sem_init(&pending_recycled_events, 0, K_SEM_MAX_LIMIT);
...
//SYS_INIT(bt_conn_tx_workq_init, POST_KERNEL, BT_CONN_TX_NOTIFY_WQ_INIT_PRIORITY);
INIT_DEVICE_EXPORT(bt_conn_tx_workq_init);
#endif /* CONFIG_BT_CONN_TX_NOTIFY_WQ */
