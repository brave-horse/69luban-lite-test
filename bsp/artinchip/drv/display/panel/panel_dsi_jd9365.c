...
#ifndef JD9365_MATCH_ID
#define JD9365_MATCH_ID 0
#endif

static int panel_jd9365_800x800_enable(struct aic_panel *panel)
{
    int ret;
...
static struct aic_panel_funcs jd9365_800x800_funcs = {
    .disable = panel_default_disable,
    .unprepare = panel_default_unprepare,
    .prepare = panel_default_prepare,
    .enable = panel_jd9365_800x800_enable,
    .register_callback = panel_register_callback,
};

static int panel_jd9365da_800x1280_enable(struct aic_panel *panel)
{
    int ret;
    ...
    panel_dsi_dcs_send_seq(panel, 0x03,0x10);
    panel_dsi_dcs_send_seq(panel, 0x04,0x6A);

    panel_dsi_dcs_send_seq(panel, 0x0C,0x74);

    panel_dsi_dcs_send_seq(panel, 0x17,0x00);
    panel_dsi_dcs_send_seq(panel, 0x18,0xBF);
    panel_dsi_dcs_send_seq(panel, 0x19,0x01);
    panel_dsi_dcs_send_seq(panel, 0x1A,0x00);
    panel_dsi_dcs_send_seq(panel, 0x1B,0xBF);
    panel_dsi_dcs_send_seq(panel, 0x1C,0x01);

    panel_dsi_dcs_send_seq(panel, 0x37,0x19);

    panel_dsi_dcs_send_seq(panel, 0x38,0x05);
    panel_dsi_dcs_send_seq(panel, 0x39,0x08);
    panel_dsi_dcs_send_seq(panel, 0x3A,0x12);
    panel_dsi_dcs_send_seq(panel, 0x3C,0x74);
    panel_dsi_dcs_send_seq(panel, 0x3D,0xFF);
    panel_dsi_dcs_send_seq(panel, 0x3E,0xFF);
    panel_dsi_dcs_send_seq(panel, 0x3F,0xFF);
    ...
    panel_dsi_dcs_send_seq(panel, 0x42,0x7E);
    panel_dsi_dcs_send_seq(panel, 0x43,0x1E);
    panel_dsi_dcs_send_seq(panel, 0x44,0x0F);
    panel_dsi_dcs_send_seq(panel, 0x45,0x28);

    panel_dsi_dcs_send_seq(panel, 0x55,0x02);
    panel_dsi_dcs_send_seq(panel, 0x57,0xA9);
    panel_dsi_dcs_send_seq(panel, 0x59,0x0A);
    panel_dsi_dcs_send_seq(panel, 0x5A,0x3D);
    panel_dsi_dcs_send_seq(panel, 0x5B,0x15);

    panel_dsi_dcs_send_seq(panel, 0x5D,0x7F);
    panel_dsi_dcs_send_seq(panel, 0x5E,0x6B);
    panel_dsi_dcs_send_seq(panel, 0x5F,0x5C);
    panel_dsi_dcs_send_seq(panel, 0x60,0x50);
    panel_dsi_dcs_send_seq(panel, 0x61,0x4D);
    panel_dsi_dcs_send_seq(panel, 0x62,0x3F);
    panel_dsi_dcs_send_seq(panel, 0x63,0x41);
    panel_dsi_dcs_send_seq(panel, 0x64,0x2A);
    panel_dsi_dcs_send_seq(panel, 0x65,0x41);
    panel_dsi_dcs_send_seq(panel, 0x66,0x3E);
    panel_dsi_dcs_send_seq(panel, 0x67,0x3C);
    panel_dsi_dcs_send_seq(panel, 0x68,0x59);
    panel_dsi_dcs_send_seq(panel, 0x69,0x45);
    panel_dsi_dcs_send_seq(panel, 0x6A,0x4A);
    panel_dsi_dcs_send_seq(panel, 0x6B,0x3A);
    panel_dsi_dcs_send_seq(panel, 0x6C,0x33);
    panel_dsi_dcs_send_seq(panel, 0x6D,0x24);
    panel_dsi_dcs_send_seq(panel, 0x6E,0x10);
    panel_dsi_dcs_send_seq(panel, 0x6F,0x02);
    panel_dsi_dcs_send_seq(panel, 0x70,0x7F);
    panel_dsi_dcs_send_seq(panel, 0x71,0x6B);
    panel_dsi_dcs_send_seq(panel, 0x72,0x5C);
    panel_dsi_dcs_send_seq(panel, 0x73,0x50);
    panel_dsi_dcs_send_seq(panel, 0x74,0x4D);
    panel_dsi_dcs_send_seq(panel, 0x75,0x3F);
    panel_dsi_dcs_send_seq(panel, 0x76,0x41);
    panel_dsi_dcs_send_seq(panel, 0x77,0x2A);
    panel_dsi_dcs_send_seq(panel, 0x78,0x41);
    panel_dsi_dcs_send_seq(panel, 0x79,0x3E);
    panel_dsi_dcs_send_seq(panel, 0x7A,0x3C);
    panel_dsi_dcs_send_seq(panel, 0x7B,0x59);
    panel_dsi_dcs_send_seq(panel, 0x7C,0x45);
    panel_dsi_dcs_send_seq(panel, 0x7D,0x4A);
    panel_dsi_dcs_send_seq(panel, 0x7E,0x3A);
    panel_dsi_dcs_send_seq(panel, 0x7F,0x33);
    panel_dsi_dcs_send_seq(panel, 0x80,0x24);
    panel_dsi_dcs_send_seq(panel, 0x81,0x10);
    panel_dsi_dcs_send_seq(panel, 0x82,0x02);

    panel_dsi_dcs_send_seq(panel, 0xE0,0x02);
    panel_dsi_dcs_send_seq(panel, 0x00,0x5F);
    panel_dsi_dcs_send_seq(panel, 0x01,0x5F);
    panel_dsi_dcs_send_seq(panel, 0x02,0x41);
    panel_dsi_dcs_send_seq(panel, 0x03,0x41);
    panel_dsi_dcs_send_seq(panel, 0x04,0x50);
    panel_dsi_dcs_send_seq(panel, 0x05,0x50);
    panel_dsi_dcs_send_seq(panel, 0x06,0x5E);
    panel_dsi_dcs_send_seq(panel, 0x07,0x5E);
    panel_dsi_dcs_send_seq(panel, 0x08,0x5F);
    panel_dsi_dcs_send_seq(panel, 0x09,0x5F);
    panel_dsi_dcs_send_seq(panel, 0x0A,0x77);
    panel_dsi_dcs_send_seq(panel, 0x0B,0x77);
    panel_dsi_dcs_send_seq(panel, 0x0C,0x57);
    panel_dsi_dcs_send_seq(panel, 0x0D,0x57);
    panel_dsi_dcs_send_seq(panel, 0x0E,0x47);
    panel_dsi_dcs_send_seq(panel, 0x0F,0x47);
    panel_dsi_dcs_send_seq(panel, 0x10,0x45);
    panel_dsi_dcs_send_seq(panel, 0x11,0x45);
    panel_dsi_dcs_send_seq(panel, 0x12,0x4B);
    panel_dsi_dcs_send_seq(panel, 0x13,0x4B);
    panel_dsi_dcs_send_seq(panel, 0x14,0x49);
    panel_dsi_dcs_send_seq(panel, 0x15,0x49);

    panel_dsi_dcs_send_seq(panel, 0x16,0x5F);
    panel_dsi_dcs_send_seq(panel, 0x17,0x5F);
    panel_dsi_dcs_send_seq(panel, 0x18,0x40);
    panel_dsi_dcs_send_seq(panel, 0x19,0x40);
    panel_dsi_dcs_send_seq(panel, 0x1A,0x50);
    panel_dsi_dcs_send_seq(panel, 0x1B,0x50);
    panel_dsi_dcs_send_seq(panel, 0x1C,0x5E);
    panel_dsi_dcs_send_seq(panel, 0x1D,0x5E);
    panel_dsi_dcs_send_seq(panel, 0x1E,0x5F);
    panel_dsi_dcs_send_seq(panel, 0x1F,0x5F);
    panel_dsi_dcs_send_seq(panel, 0x20,0x77);
    panel_dsi_dcs_send_seq(panel, 0x21,0x77);
    panel_dsi_dcs_send_seq(panel, 0x22,0x57);
    panel_dsi_dcs_send_seq(panel, 0x23,0x57);
    panel_dsi_dcs_send_seq(panel, 0x24,0x46);
    panel_dsi_dcs_send_seq(panel, 0x25,0x46);
    panel_dsi_dcs_send_seq(panel, 0x26,0x44);
    panel_dsi_dcs_send_seq(panel, 0x27,0x44);
    panel_dsi_dcs_send_seq(panel, 0x28,0x4A);
    panel_dsi_dcs_send_seq(panel, 0x29,0x4A);
    panel_dsi_dcs_send_seq(panel, 0x2A,0x48);
    panel_dsi_dcs_send_seq(panel, 0x2B,0x48);

    panel_dsi_dcs_send_seq(panel, 0x2C,0x1F);
    panel_dsi_dcs_send_seq(panel, 0x2D,0x1F);
    panel_dsi_dcs_send_seq(panel, 0x2E,0x00);
    panel_dsi_dcs_send_seq(panel, 0x2F,0x00);
    panel_dsi_dcs_send_seq(panel, 0x30,0x10);
    panel_dsi_dcs_send_seq(panel, 0x31,0x10);
    panel_dsi_dcs_send_seq(panel, 0x32,0x1F);
    panel_dsi_dcs_send_seq(panel, 0x33,0x1F);
    panel_dsi_dcs_send_seq(panel, 0x34,0x1E);
    panel_dsi_dcs_send_seq(panel, 0x35,0x1E);
    panel_dsi_dcs_send_seq(panel, 0x36,0x17);
    panel_dsi_dcs_send_seq(panel, 0x37,0x17);
    panel_dsi_dcs_send_seq(panel, 0x38,0x17);
    panel_dsi_dcs_send_seq(panel, 0x39,0x17);
    panel_dsi_dcs_send_seq(panel, 0x3A,0x08);
    panel_dsi_dcs_send_seq(panel, 0x3B,0x08);
    panel_dsi_dcs_send_seq(panel, 0x3C,0x0A);
    panel_dsi_dcs_send_seq(panel, 0x3D,0x0A);
    panel_dsi_dcs_send_seq(panel, 0x3E,0x04);
    panel_dsi_dcs_send_seq(panel, 0x3F,0x04);
    panel_dsi_dcs_send_seq(panel, 0x40,0x06);
    panel_dsi_dcs_send_seq(panel, 0x41,0x06);

    panel_dsi_dcs_send_seq(panel, 0x42,0x1F);
    panel_dsi_dcs_send_seq(panel, 0x43,0x1F);
    panel_dsi_dcs_send_seq(panel, 0x44,0x01);
    panel_dsi_dcs_send_seq(panel, 0x45,0x01);
    panel_dsi_dcs_send_seq(panel, 0x46,0x10);
    panel_dsi_dcs_send_seq(panel, 0x47,0x10);
    panel_dsi_dcs_send_seq(panel, 0x48,0x1F);
    panel_dsi_dcs_send_seq(panel, 0x49,0x1F);
    panel_dsi_dcs_send_seq(panel, 0x4A,0x1E);
    panel_dsi_dcs_send_seq(panel, 0x4B,0x1E);
    panel_dsi_dcs_send_seq(panel, 0x4C,0x17);
    panel_dsi_dcs_send_seq(panel, 0x4D,0x17);
    panel_dsi_dcs_send_seq(panel, 0x4E,0x17);
    panel_dsi_dcs_send_seq(panel, 0x4F,0x17);
    panel_dsi_dcs_send_seq(panel, 0x50,0x09);

    panel_dsi_dcs_send_seq(panel, 0x51,0x09);
    panel_dsi_dcs_send_seq(panel, 0x52,0x0B);
    panel_dsi_dcs_send_seq(panel, 0x53,0x0B);
    panel_dsi_dcs_send_seq(panel, 0x54,0x05);
    panel_dsi_dcs_send_seq(panel, 0x55,0x05);
    panel_dsi_dcs_send_seq(panel, 0x56,0x07);
    panel_dsi_dcs_send_seq(panel, 0x57,0x07);

    panel_dsi_dcs_send_seq(panel, 0x58,0x40);
    panel_dsi_dcs_send_seq(panel, 0x5B,0x10);
    panel_dsi_dcs_send_seq(panel, 0x5C,0x07);
    panel_dsi_dcs_send_seq(panel, 0x5D,0x30);
    panel_dsi_dcs_send_seq(panel, 0x5E,0x01);
    panel_dsi_dcs_send_seq(panel, 0x5F,0x02);
    panel_dsi_dcs_send_seq(panel, 0x60,0x30);
    panel_dsi_dcs_send_seq(panel, 0x63,0x03);
    panel_dsi_dcs_send_seq(panel, 0x64,0x62);
    panel_dsi_dcs_send_seq(panel, 0x65,0x40);
    panel_dsi_dcs_send_seq(panel, 0x66,0x02);
    panel_dsi_dcs_send_seq(panel, 0x67,0x73);
    panel_dsi_dcs_send_seq(panel, 0x68,0x09);
    panel_dsi_dcs_send_seq(panel, 0x69,0x03);
    panel_dsi_dcs_send_seq(panel, 0x6A,0x62);
    panel_dsi_dcs_send_seq(panel, 0x6B,0x08);
    ...
    panel_dsi_dcs_send_seq(panel, 0x6F,0x88);
    panel_dsi_dcs_send_seq(panel, 0x75,0xF8);
    panel_dsi_dcs_send_seq(panel, 0x76,0x00);
    panel_dsi_dcs_send_seq(panel, 0x77,0x05);
    panel_dsi_dcs_send_seq(panel, 0x78,0x2E);

    panel_dsi_dcs_send_seq(panel, 0xE0,0x04);
    panel_dsi_dcs_send_seq(panel, 0x00,0x0E);
    panel_dsi_dcs_send_seq(panel, 0x02,0xB3);
    panel_dsi_dcs_send_seq(panel, 0x09,0x60);
    panel_dsi_dcs_send_seq(panel, 0x0E,0x48);
    panel_dsi_dcs_send_seq(panel, 0x37,0x58);
    panel_dsi_dcs_send_seq(panel, 0x2B,0x0F);
...
static struct aic_panel_funcs jd9365da_800x1280_funcs = {
    .disable = panel_default_disable,
    .unprepare = panel_default_unprepare,
    .prepare = panel_default_prepare,
    .enable = panel_jd9365da_800x1280_enable,
    .register_callback = panel_register_callback,
};

static struct display_timing jd9365_800x800_timing = {
    .pixelclock = 60000000,
    .hactive = 800,
    .hfront_porch = 60,
    .hback_porch = 20,
...
static struct display_timing jd9365da_800x1280_timing = {
    .pixelclock = 70000000,
    .hactive = 800,
    .hfront_porch = 40,
    .hback_porch = 20,
...
static struct panel_desc desc[] = {
    [0] = {
        .name = "jd9365-default",
        .dsi = &dsi,
        .timings = &jd9365_800x800_timing,
        .funcs = &jd9365_800x800_funcs,
    },
    [1] = {
        .name = "jd9365da",
        .dsi = &dsi,
        .timings = &jd9365da_800x1280_timing,
        .funcs = &jd9365da_800x1280_funcs,
    },
};
